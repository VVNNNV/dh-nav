...
<div class="archive-page">
    ...
    <header class="site-header">
        <div class="site-header-inner">
            ...
            <span class="site-header-count">共收录 <strong><?php echo $tools->found_posts; ?></strong> 个网站</span>
        </div>
    </header>
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <!-- 标题 -->
            <h1 class="page-title">网站大全</h1>
            
            <!-- 描述 -->
            <p class="page-description">发现最优质的网站，提升工作效率</p>
            
            <!-- 统计 -->
            <div class="page-stats">
                共收录 <span class="stat-value"><?php echo $tools->found_posts; ?></span> 个优质网站
            </div>
        </div>
    </div>
    ...
    <section class="tools-section">
        ...
        <?php else : ?>
            <div class="empty-state">
                ...
                <p class="empty-text">还没有添加任何网站</p>
            </div>
        <?php endif; ?>
    </section>
