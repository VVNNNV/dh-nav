...
<div class="taxonomy-page">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <!-- 分类图标 -->
            <div class="card-icon" style="margin: 0 auto 20px; width: 80px; height: 80px; font-size: 40px;">
                📂
            </div>
            ...
            <?php if ($term_description) : ?>
                <p class="page-description"><?php echo esc_html($term_description); ?></p>
            <?php endif; ?>
            ...
            <div class="page-stats">
                ...
                <?php if (!empty($child_categories)) : ?>
                    <div class="stat-item">
                        <span>📁</span>
                        <span class="stat-value"><?php echo count($child_categories); ?></span>
                        <span>个子分类</span>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="category-nav-list">
            ...
            <?php foreach ($all_categories as $cat) : ?>
                <a href="<?php echo get_term_link($cat); ?>" 
                   class="category-nav-item <?php echo $cat->term_id == $term_id ? 'active' : ''; ?>">
    ...
    <?php if (!empty($child_categories)) : ?>
        <div class="child-categories">
            <div class="child-categories-title">子分类</div>
            <div class="child-categories-list">
                <?php foreach ($child_categories as $child) : ?>
                    <a href="<?php echo get_term_link($child); ?>" class="child-category-item">
                        📁 <?php echo esc_html($child->name); ?>
                        <span style="color: var(--text-secondary);">(<?php echo $child->count; ?>)</span>
                    </a>
                <?php endforeach; ?>
            </div>
        </div>
    ...
    <section class="tools-section">
        <div class="section-header">
            <h2 class="section-title">🔧 <?php echo esc_html($term_name); ?> 下的网站</h2>
            <span class="tools-count">共 <?php echo $tools->found_posts; ?> 个</span>
        </div>
        ...
        <?php else : ?>
            <div class="empty-state">
                ...
                <p class="empty-text">该分类下还没有添加任何网站</p>
            </div>
        <?php endif; ?>
    </section>
